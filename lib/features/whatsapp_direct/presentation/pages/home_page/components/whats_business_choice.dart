...
class WhatsBusinessChoice extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create: (context) => serviceLocator.get<CheckPackageLogicCubit>()
            ..checkWhatsBusinessInstalled(),
        ),
        BlocProvider(
          create: (context) => serviceLocator.get<IsWhatsappBusinessCubit>(),
        ),
      ],
      child: BlocBuilder<CheckPackageLogicCubit, bool>(
